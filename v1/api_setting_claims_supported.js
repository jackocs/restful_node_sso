    ...
    child = exec(
      ...
      function (error, stdout, stderr) {
        ...
        connection.connect(function (err) {
          ...
          connection.query(
            "select COUNT(*) as count from oauth_conf where conf='claims_supported'",
                  ...
                  connection.query(
                    ...
                    function (error, results, fields) {
                      if (error) {
                        ...
                        exec(
                          "php /home/xIDM-SSO-Cent8/sso/idp/config/mysql2redis_local.php oauth_conf update claims_supported",
                          function (error, stdout, stderr) {
                            if (error !== null) {
                              result = { status: "fail", result: error };
                              return res.json(result);
