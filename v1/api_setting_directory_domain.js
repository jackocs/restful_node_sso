...
router.get('/:type', function (req, res) {
	...
	child = exec("/home/restful_node_sso/sh/setting_directory_domain.pl "+ type , function (error, stdout, stderr) {
	  ...
	  if (error !== null) {
		console.log('exec error: ' + error);
            ...
            result = {'status':'fail','result': 'Undefined Value true/false Found'};
