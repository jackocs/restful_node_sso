    ...
    child = exec(
      ...
      function (error, stdout, stderr) {
        ...
        connection.connect(function (err) {
          ...
          connection.query(
            "select COUNT(*) as count from oauth_group_policy where group_policy_id='" +
              group_policy_id +
              "'",
            function (error, results, fields) {
              if (error) {
                ...
                if (results[0].count === 0) {
                  ...
                  var sql =
                    "UPDATE oauth_group_policy SET group_policy_rule='" +
                    group_policy_rule +
                    "' WHERE group_policy_id=?";
                  ...
                  connection.query(
                    ...
                    function (error, results, fields) {
                      if (error) {
                        ...
                        exec(
                          "php /home/xIDM-SSO-Cent8/sso/idp/config/mysql2redis_local.php oauth_group_policy edit " +
                            group_policy_id,
                          function (error, stdout, stderr) {
                            if (error !== null) {
                              result = { status: "fail", result: error };
