...
router.get('/:group_policy_name', function (req, res) {
    if (req.params.group_policy_name === undefined || req.params.group_policy_name === null){
        result = {'status':'fail','result': 'Undefined Value Found'};
        return res.json(result);
    }
    var group_policy_name=req.params.group_policy_name.trim();
	child = exec("/home/restful_node_sso/sh/groupPolicy.pl "+ group_policy_name, function (error, stdout, stderr) {
