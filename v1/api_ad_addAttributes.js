    ...
    child = exec(
      ...
      function (error, stdout, stderr) {
        ...
        connection.connect(function (err) {
          ...
          connection.query(
            "select COUNT(*) as count from oauth_objectclasses where attribute='" +
              attribute +
              "'",
            function (error, results, fields) {
              if (error) {
                ...
                if (results[0].count > 0) {
                  ...
                  var sql =
                    "INSERT INTO oauth_objectclasses (attribute,objectclass,type,description,is_default) VALUES ?";
                  ...
                  connection.query(
                    ...
                    function (error, results, fields) {
                      if (error) {
                        ...
                        exec(
                          "php /home/xIDM-SSO-Cent8/sso/idp/config/mysql2redis_local.php oauth_objectclasses add " +
                            attribute,
                          function (error, stdout, stderr) {
                            if (error !== null) {
                              result = { status: "fail", result: error };
